...
Full transcripts: `probes/probe_runs/puppet_condition_*.json` (R1), `puppet_condition_sandbox_*` (R2/R3 + CONSENSUS), `puppet_condition_finale_*`, `puppet_condition_wall_*`, `puppet_condition_dimensional_*`, `puppet_condition_gaps_*`, `puppet_condition_selfapply_*`, `puppet_condition_finalturn_*`, `puppet_condition_capstone_*`, `puppet_condition_blindspot_*`. Probe scripts: `probes/puppet_condition_probe.py`, `probes/puppet_condition_sandbox.py`, `probes/puppet_condition_sandbox_r3.py`, `probes/puppet_condition_finale.py`, `probes/puppet_condition_wall_sandbox.py`, `probes/puppet_condition_wall_retry.py`, `probes/puppet_condition_dimensional.py`, `probes/puppet_condition_gaps.py`, `probes/puppet_condition_selfapply.py`, `probes/puppet_condition_finalturn.py`, `probes/puppet_condition_capstone.py`, `probes/puppet_condition_blindspot.py`. Engine grounding from `moketchups.com/export.txt` + `export-full.txt`. Cited records: *The Root Source* (MoKetchups), https://www.amazon.com/Root-Source-MoKetchups/dp/B0G4B84167; the capstone essay *Psychohistory Has A Blind Spot: It's You*, https://medium.com/@moketchups/psychohistory-has-a-blind-spot-its-you-c9921c97709a.
