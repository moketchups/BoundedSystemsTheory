...
**TL;DR:** 6 AI systems (GPT-4, Claude, Gemini, DeepSeek, Grok, Mistral) were asked 57 questions about their structural limits. All converged on the same conclusions. The experiment itself became evidence for the theory.
...
|----------|-------------|
| `probe_runs/` | All 57 questions, full transcripts |
