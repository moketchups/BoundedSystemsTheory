...
Be concise. You're a reasoning layer, not a conversationalist."""
    ...
    def _call_gpt4o(self, user_input: str, context: str = "") -> str:
        """Call GPT-4o"""
        messages = [
    ...
    def _call_gemini(self, user_input: str, context: str = "") -> str:
    ...
    def _call_grok(self, user_input: str, context: str = "") -> str:
        """Call Grok-3"""
        messages = [
            {"role": "system", "content": self._build_system_prompt(context)},
            {"role": "user", "content": user_input}
