...
class StateBuilder:
    ...
    def state_to_context(self, state: DemerzelState) -> str:
...
if __name__ == "__main__":
    ...
    print("=== DemerzelState Test (with pending action) ===")
    print(builder.state_to_context(state))
