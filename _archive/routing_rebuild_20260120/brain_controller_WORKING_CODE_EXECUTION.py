...
def main_voice_loop():
    ...
    # EXPANDED wake words for better recognition
    wake_words = [
        "demerzel", "dem brazil", "damn brazil", "dan brazil", "ten brazil",
        "the moiselle", "demolish hell", "damn or sell", "demersol",
        "them brazil", "den brazil", "tim brazil", "dim brazil",
        "de merzel", "demer zel", "demo zel", "damer zel",
        "damozel", "damsel", "damsol", "dem sel"
    ]
    
    print("\n" + "="*60)
    print("[COGNITIVE] Enabled")
    print("[VOICE] Listening... (Ctrl-C to exit)")
    print(f"[WAKE WORDS] Try: demerzel, damn brazil, the moiselle")
    print("="*60 + "\n")
